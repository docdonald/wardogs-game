...
export const GET: APIRoute = async () => {
  ...
  const lines: string[] = [
    ...
    `> ${site.description}`,
    '',
    `Wiki for ${site.game.name} (${site.game.platform}, by ${site.game.developer}). Articles cover release access, gameplay, mechanics, weapons, vehicles, updates, and beginner guides.`,
    '',
    '## Articles',
    '',
  ];
