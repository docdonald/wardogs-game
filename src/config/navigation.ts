...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  { key: 'release', path: '/release', icon: 'lucide:calendar-days', isContentType: true, order: 1 },
  { key: 'guides', path: '/guides', icon: 'lucide:book-open', isContentType: true, order: 2 },
  { key: 'mechanics', path: '/mechanics', icon: 'lucide:workflow', isContentType: true, order: 3 },
  { key: 'weapons', path: '/weapons', icon: 'lucide:crosshair', isContentType: true, order: 4 },
  { key: 'vehicles', path: '/vehicles', icon: 'lucide:truck', isContentType: true, order: 5 },
  { key: 'updates', path: '/updates', icon: 'lucide:refresh-cw', isContentType: true, order: 6 },
];

/** Derived list of content type slugs used by the WARDOGS site routes. */
